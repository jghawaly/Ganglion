...
from NeuralGroup import SensoryNeuralGroup, AdExNeuralGroup
...
if __name__ == "__main__":
    ...
    if mode == "single_network":
        ...
        g2 = AdExNeuralGroup(np.ones(3, dtype=np.int), "George", tki, ExLIFParams())
        g3 = AdExNeuralGroup(np.ones(2, dtype=np.int), "Ada", tki, ExLIFParams())
